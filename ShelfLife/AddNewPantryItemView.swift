...
struct AddNewPantryItemView: View {
    ...
    let categories = ["Grains & Pastas", "Snacks", "Canned Goods", "Condiments", "Other"]
...
struct AddNewPantryItemView_Previews: PreviewProvider {
